...
const SendEmailMessage = ({ onClose, emailData, fetchData }) => {
  ...
  return (
    <div>
      <div className='fixed top-0 bottom-0 left-0 right-0 pt-5 pl-80 w-full h-full z-10 flex justify-center items-center bg-blue-200 bg-opacity-70'>
          ...
          <div className="w-full max-w-md">
            ...
            <form className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" onSubmit={handleSubmit}>
              ...
              <div className="mb-4">
                ...
                <input
                  className="appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                  value="hotelelephantbay@gmail.com"
                  readOnly
                />
              </div>
              <div className="mb-4">
