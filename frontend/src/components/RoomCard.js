...
import fetchCategoryWiseRoom from "../helpers/fetchCategoryWiseRoom";
...
const RoomCard = ({ category }) => {
  ...
  const fetchData = async () => {
    setLoading(true);
    const categoryRoom = await fetchCategoryWiseRoom(category);
    setLoading(false);

    console.log("horizontal data", categoryRoom.data);
    setData(categoryRoom?.data);
  };
                          ...
                          <div className=" single-blog-wrap type3">
                            <div className="row align-items-center">
                                ...
                                <div className="single-post-details left-content">
                                  ...
                                  <div className="post-body">
                                    ...
                                    <div className="reading-and-reply d-flex align-items-center justify-content-between">
                                      <Link
                                        to={
                                          "room-category-details/" + room._id
                                        }
                              ...
                              <div className="col-md-5 col-lg-4 order-first order-md-last">
                                {/* single blog image */}
                                <Link
                                  to={"Room-category-details/" + room._id}
