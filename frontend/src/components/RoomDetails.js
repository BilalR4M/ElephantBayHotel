...
import Sidebar from "../components/RoomDetailSidebar";
                      ...
                      <div className="share-and-tag">
                        <div className="row justify-content-center">
                          <div className="col-lg-12">
                            ...
                            <div className="single-post-tag-share w-full p-2 bg-slate-100 ">
                              {/* single post tags */}
                  ...
                  <div className="row justify-content-center">
                    <div className="col-lg-12">
                      <div className="post-main-content text-center">
                        ...
                        <div className="post-main-image ">
                          {data.RoomImageImage.map((imageUrl, index) => {
                            return (
                              <div
                                key={index}
